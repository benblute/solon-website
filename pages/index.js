  ...
  return (
    <main>
      ...
      <Section image="/blob1.png">
        ...
        <Paragraph>Solon is working to create the world&apos;s largest decentralized ecosystem, including he world’s first AMM with the ability to fully mitigate impermanent loss</Paragraph>
      </Section>
